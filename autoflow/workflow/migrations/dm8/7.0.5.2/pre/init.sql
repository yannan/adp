...
CREATE TABLE IF NOT EXISTS "t_wf_activity_info_config"  (
  "activity_def_id" varchar(100 char) NOT NULL COMMENT '流程环节定义ID',
  "activity_def_name" varchar(100 char) NULL DEFAULT NULL COMMENT '流程环节定义名称',
  "process_def_id" varchar(100 char) NOT NULL COMMENT '流程定义ID',
  "process_def_name" varchar(500 char) NULL DEFAULT NULL COMMENT '流程定义名称',
  "activity_page_url" varchar(500 char) NULL DEFAULT NULL COMMENT '流程环节表单URL',
  "activity_page_info" text NULL COMMENT '流程环节表单数据',
  "activity_operation_roleid" varchar(4000 char) NULL DEFAULT NULL COMMENT '流程环节绑定操作权限ID',
  "remark" varchar(500 char) NULL DEFAULT NULL COMMENT '备注',
  "jump_type" varchar(10 char) NULL DEFAULT NULL COMMENT '环节跳转类型，AUTO：自动路径跳转；MANUAL：人工选择跳转、FREE：自由选择跳转',
  "activity_status_name" varchar(100 char) NULL DEFAULT NULL COMMENT '流程环节状态名称(默认与环节名称一致)',
  ...
  "idea_display_area" varchar(50 char) NULL DEFAULT NULL COMMENT '意见分栏',
  "is_show_idea" varchar(10 char) NULL DEFAULT NULL COMMENT '是否显示意见输入区域,默认启用ENABLED,否则禁用DISABLE',
  "activity_def_child_type" varchar(20 char) NULL DEFAULT NULL COMMENT '环节子类型，through:流程贯穿,inside:内部流程',
  "activity_def_deal_type" varchar(20 char) NULL DEFAULT NULL COMMENT '环节处理类型，单人多人',
  "activity_def_type" varchar(20 char) NULL DEFAULT NULL COMMENT '环节类型',
  "is_start_usertask" varchar(4 char) NULL DEFAULT NULL COMMENT '是否是开始节点  是为Y  否为N',
  "c_protocl" varchar(50 char) NULL DEFAULT NULL COMMENT 'PC端协议',
  "m_protocl" varchar(50 char) NULL DEFAULT NULL COMMENT '移动端协议',
  "m_url" varchar(500 char) NULL DEFAULT NULL COMMENT '手机端待办地址',
  "other_sys_deal_status" varchar(10 char) NULL DEFAULT NULL COMMENT '其它系统处理状态   0 不可处理；1 仅阅读；2可处理',
...
CREATE TABLE IF NOT EXISTS "t_wf_activity_rule"  (
  "rule_id" varchar(50 char) NOT NULL COMMENT '规则ID',
  "rule_name" varchar(250 char) NOT NULL COMMENT '规则名称',
  "proc_def_id" varchar(100 char) NULL DEFAULT NULL COMMENT '流程定义ID',
  "source_act_id" varchar(50 char) NULL DEFAULT NULL COMMENT '源环节ID',
  "target_act_id" varchar(50 char) NULL DEFAULT NULL COMMENT '目标环节ID',
  "rule_script" text NOT NULL COMMENT '规则脚本',
  "rule_priority" decimal(10, 0) NULL DEFAULT NULL COMMENT '优先级',
  "rule_type" varchar(5 char) NULL DEFAULT NULL COMMENT '规则类型：A：环节，R：资源，F:多实例环节完成条件',
  "tenant_id" varchar(255 char) NOT NULL COMMENT '租户ID',
  "rule_remark" varchar(2000 char) NULL DEFAULT NULL COMMENT '备注',
...
CREATE TABLE IF NOT EXISTS "t_wf_application"  (
  "app_id" varchar(50 char) NOT NULL COMMENT '应用系统ID',
  "app_name" varchar(50 char) NULL DEFAULT NULL COMMENT '应用系统名称',
  "app_type" varchar(20 char) NULL DEFAULT NULL COMMENT '应用系统分类',
  "app_access_url" varchar(300 char) NULL DEFAULT NULL COMMENT '应用系统访问地址',
  ...
  "app_creator_id" varchar(50 char) NULL DEFAULT NULL COMMENT '应用系统创建人ID',
  "app_updator_id" varchar(50 char) NULL DEFAULT NULL COMMENT '应用系统更新人ID',
  "app_status" varchar(2 char) NULL DEFAULT NULL COMMENT '应用系统状态',
  "app_desc" varchar(300 char) NULL DEFAULT NULL COMMENT '应用系统描述',
  "app_provider" varchar(100 char) NULL DEFAULT NULL COMMENT '应用系统开发厂商',
  "app_linkman" varchar(50 char) NULL DEFAULT NULL COMMENT '应用系统联系人',
  "app_phone" varchar(30 char) NULL DEFAULT NULL COMMENT '应用系统联系电话',
  "app_unitework_check_url" varchar(300 char) NULL DEFAULT NULL COMMENT '应用系统检查路径',
  "app_sort" decimal(10, 0) NULL DEFAULT NULL COMMENT '应用系统排序号',
  "app_shortname" varchar(50 char) NULL DEFAULT NULL COMMENT '应用系统简洁名称',
...
CREATE TABLE IF NOT EXISTS "t_wf_application_user"  (
  "app_id" varchar(50 char) NOT NULL COMMENT '租户ID',
  "user_id" varchar(50 char) NOT NULL COMMENT '用户ID',
  "remark" varchar(300 char) NULL DEFAULT NULL COMMENT '备注',
...
CREATE TABLE IF NOT EXISTS "t_wf_dict"  (
  ...
  "dict_code" varchar(50 char) NULL DEFAULT NULL COMMENT '字典编码',
  "dict_parent_id" varchar(50 char) NULL DEFAULT NULL COMMENT '字典上级主键id',
  "dict_name" text NULL COMMENT '字典名称',
  "sort" decimal(10, 0) NULL DEFAULT NULL COMMENT '排序号',
  "status" varchar(2 char) NULL DEFAULT NULL COMMENT '状态',
  "creator_id" varchar(50 char) NULL DEFAULT NULL COMMENT '创建人',
  "create_date" datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  "updator_id" varchar(50 char) NULL DEFAULT NULL COMMENT '更新人',
  "update_date" datetime(0) NULL DEFAULT NULL COMMENT '最后更新时间',
  "app_id" varchar(50 char) NOT NULL COMMENT '应用id',
  "dict_value" varchar(4000 char) NULL DEFAULT NULL COMMENT '字典值',
...
CREATE TABLE IF NOT EXISTS "t_wf_doc_audit_apply"  (
  "id" varchar(50 char) NOT NULL COMMENT '申请ID',
  "biz_id" varchar(50 char) NOT NULL COMMENT '业务关联ID，如：AS共享申请ID',
  "doc_id" text NULL COMMENT '文档ID，如：gns://xxx/xxx',
  "doc_path" varchar(1000 char) NULL DEFAULT NULL COMMENT '文档路径，如：/name/xxx.txt',
  "doc_type" varchar(10 char) NULL DEFAULT NULL COMMENT '文档类型（folder文件夹,file文件,doc_lib文档库）',
  "csf_level" int NULL DEFAULT NULL COMMENT '文件密级,5~15，如果是文件夹，则为0',
  "biz_type" varchar(100 char) NULL DEFAULT NULL COMMENT '业务类型（realname共享给指定用户的申请，anonymous共享给任意用户的申请，sync同步申请，flow流转申请，security定密申请）',
  "apply_type" varchar(100 char) NOT NULL COMMENT '申请类型（sync同步申请，flow流转申请，perm共享申请，anonymous匿名申请，owner所有者申请，security定密申请，inherit更改继承申请）',
  "apply_detail" text NOT NULL COMMENT '申请明细（docLibType文档库ID，accessorId访问者ID，accessorName访问者名称，accessorType访问者类型，allowValue允许权限，denyValue拒绝权限，inherit是否继承权限，expiresAt有效期，opType操作类型，linkUrl链接地址，title链接标题，password密码，accessLimit访问次数）',
  "proc_def_id" varchar(100 char) NULL DEFAULT NULL COMMENT '流程定义ID',
  "proc_def_name" varchar(300 char) NULL DEFAULT NULL COMMENT '流程定义名称',
  "proc_inst_id" varchar(100 char) NULL DEFAULT NULL COMMENT '流程实例ID',
  "audit_type" varchar(10 char) NULL DEFAULT NULL COMMENT '审核模式（tjsh-同级审核，hqsh-汇签审核，zjsh-逐级审核）',
  "auditor" text NULL COMMENT '审核员，冗余字段，用于页面展示(id审核人ID，name审核人名称，status审核状态，auditDate审核时间)',
  "apply_user_id" varchar(50 char) NOT NULL COMMENT '申请人ID',
  "apply_user_name" varchar(150 char) NULL DEFAULT NULL COMMENT '申请人名称',
  "apply_time" datetime(0) NOT NULL COMMENT '申请时间',
  "doc_names" varchar(2000 char) NULL DEFAULT NULL COMMENT '文档名称',
  CLUSTER PRIMARY KEY ("id")
);
...
CREATE TABLE IF NOT EXISTS "t_wf_doc_audit_detail"  (
  "id" varchar(50 char) NOT NULL COMMENT '主键ID',
  "apply_id" varchar(50 char) NOT NULL COMMENT '申请ID',
  "doc_id" text NOT NULL COMMENT '文档ID，如：gns://xxx/xxx',
  "doc_path" varchar(1000 char) NOT NULL COMMENT '文档路径，如：/name/xxx.txt',
  "doc_type" varchar(10 char) NOT NULL COMMENT '文档类型（folder文件夹,file文件,doc_lib文档库）',
  "csf_level" int NULL DEFAULT NULL COMMENT '文件密级,5~15，如果是文件夹，则为0',
  "doc_name" varchar(1000 char) NULL DEFAULT NULL COMMENT '文件名称',
  CLUSTER PRIMARY KEY ("id")
);
...
CREATE TABLE IF NOT EXISTS "t_wf_doc_audit_history"  (
  ...
  "csf_level" int NULL DEFAULT NULL COMMENT '文件密级,5~15，如果是文件夹，则为0',
  "biz_type" varchar(100 char) NULL DEFAULT NULL COMMENT '业务类型（realname共享给指定用户的申请，anonymous共享给任意用户的申请，sync同步申请，flow流转申请，security定密申请）',
  "apply_type" varchar(100 char) NOT NULL COMMENT '申请类型（sync同步申请，flow流转申请，perm共享申请，anonymous匿名申请，owner所有者申请，security更改密级申请，inherit更改继承申请）',
  "apply_detail" text NOT NULL COMMENT '申请明细（docLibType文档库ID，accessorId访问者ID，accessorName访问者名称，accessorType访问者类型，allowValue允许权限，denyValue拒绝权限，inherit是否继承权限，expiresAt有效期，opType操作类型，linkUrl链接地址，title链接标题，password密码，accessLimit访问次数）',
  "proc_def_id" varchar(100 char) NULL DEFAULT NULL COMMENT '流程定义ID',
  "proc_def_name" varchar(300 char) NULL DEFAULT NULL COMMENT '流程定义名称',
  "proc_inst_id" varchar(100 char) NULL DEFAULT NULL COMMENT '流程实例ID',
  ...
  "apply_user_name" varchar(150 char) NULL DEFAULT NULL COMMENT '申请人名称',
  "apply_time" datetime(0) NOT NULL COMMENT '申请时间',
  "audit_status" int NOT NULL COMMENT '审核状态，1-审核中 2-已拒绝 3-已通过 4-自动审核通过 5-作废  6-发起失败',
  "audit_result" varchar(10 char) NULL DEFAULT NULL COMMENT '审核结果，pass-通过 reject-拒绝',
  "audit_msg" varchar(2400 char) NULL DEFAULT NULL COMMENT '最后一次审核意见，默认为审核意见，当审核状态为6时代表发起失败异常码，异常码包含：S0001未配置审核策略;S0002无匹配审核员;S0003无匹配的审核员（发起人与审核人为同一人);S0004无匹配密级审核员',
  "audit_type" varchar(10 char) NULL DEFAULT NULL COMMENT '审核模式（tjsh-同级审核，hqsh-汇签审核，zjsh-逐级审核）',
  "auditor" text NULL COMMENT '审核员，冗余字段，用于页面展示(id审核人ID，name审核人名称，status审核状态，auditDate审核时间)',
...
CREATE TABLE IF NOT EXISTS "t_wf_doc_share_strategy"  (
  "id" varchar(50 char) NOT NULL COMMENT '主键',
  "doc_id" varchar(200 char) NULL DEFAULT NULL COMMENT '文档库ID',
  "doc_name" varchar(300 char) NULL DEFAULT NULL COMMENT '文档库名称',
  "doc_type" varchar(100 char) NULL DEFAULT NULL COMMENT '文档库类型，个人文档库：user_doc_lib；部门文档库：department_doc_lib；自定义文档库：custom_doc_lib; 知识库: knowledge_doc_lib',
  "audit_model" varchar(100 char) NOT NULL COMMENT '审核模式，同级审核：tjsh；汇签审核：hqsh；逐级审核：zjsh；',
  "proc_def_id" varchar(300 char) NOT NULL COMMENT '流程定义ID',
  "proc_def_name" varchar(300 char) NOT NULL COMMENT '流程定义名称',
  "act_def_id" varchar(100 char) NULL DEFAULT NULL COMMENT '流程环节ID',
  "act_def_name" varchar(300 char) NULL DEFAULT NULL COMMENT '流程环节名称',
  "create_user_id" varchar(100 char) NULL DEFAULT NULL COMMENT '创建人ID',
  "create_user_name" varchar(100 char) NULL DEFAULT NULL COMMENT '创建人名称',
  "create_time" datetime(0) NOT NULL COMMENT '创建时间',
  "strategy_type" varchar(50 char) NULL DEFAULT NULL COMMENT '策略类型，指定用户审核：named_auditor；部门审核员：dept_auditor；连续多级部门审核：multilevel',
  "rule_type" varchar(50 char) NULL DEFAULT NULL COMMENT '规则类型，角色：role',
  "rule_id" varchar(100 char) NULL DEFAULT NULL COMMENT '规则ID',
  "level_type" varchar(100 char) NULL DEFAULT NULL COMMENT '匹配级别类型，直属部门向上一级：belongUp1；直属部门向上二级：belongUp2；直属部门向上三级：belongUp3；直属部门向上四级：belongUp4；直属部门向上五级：belongUp5；直属部门向上六级：belongUp6；直属部门向上七级：belongUp7；直属部门向上八级：belongUp8；直属部门向上九级：belongUp9；直属部门向上十级：belongUp10；最高级部门审核员：highestLevel；最高级部门向下一级：highestDown1；最高级部门向下二级：highestDown2；最高级部门向下三级：highestDown3；最高级部门向下四级：highestDown4；最高级部门向下五级：highestDown5；最高级部门向下六级：highestDown6；最高级部门向下七级：highestDown7；最高级部门向下八级：highestDown8；最高级部门向下九级：highestDown9；最高级部门向下十级：highestDown10；',
  "no_auditor_type" varchar(50 char) NULL DEFAULT NULL COMMENT '未匹配到部门审核员类型，自动拒绝：auto_reject；自动通过：auto_pass',
  "repeat_audit_type" varchar(50 char) NULL DEFAULT NULL COMMENT '同一审核员重复审核类型，只需审核一次：once；每次都需要审核：always',
  "own_auditor_type" varchar(50 char) NULL DEFAULT NULL COMMENT '审核员为发起人自己时审核类型，自动拒绝：auto_reject；自动通过：auto_pass',
  "countersign_switch" varchar(10 char) NULL DEFAULT NULL COMMENT '是否允许加签 Y-是',
  "countersign_count" varchar(10 char) NULL DEFAULT NULL COMMENT '允许最大加签次数',
  "countersign_auditors" varchar(10 char) NULL DEFAULT NULL COMMENT '允许最大加签人数',
  "transfer_switch" varchar(10 char) NULL DEFAULT NULL COMMENT '转审开关',
  "transfer_count" varchar(10 char) NULL DEFAULT NULL COMMENT '最大转审次数',
  CLUSTER PRIMARY KEY ("id")
);
...
CREATE TABLE IF NOT EXISTS "t_wf_doc_share_strategy_auditor"  (
  "id" varchar(50 char) NOT NULL COMMENT '主键',
  "user_id" varchar(300 char) NOT NULL COMMENT '审核人',
  "user_code" varchar(300 char) NOT NULL COMMENT '审核人账号',
  "user_name" varchar(300 char) NOT NULL COMMENT '审核人名称',
  "user_dept_id" varchar(300 char) NULL DEFAULT NULL COMMENT '审核人部门ID',
  "user_dept_name" varchar(300 char) NULL DEFAULT NULL COMMENT '审核人部门名称',
  "audit_strategy_id" varchar(100 char) NULL DEFAULT NULL COMMENT '审核策略ID（t_wf_doc_audit_strategy主键）',
  "audit_sort" int NULL DEFAULT NULL COMMENT '审核人排序',
  "create_user_id" varchar(100 char) NULL DEFAULT NULL COMMENT '创建人ID',
  "create_user_name" varchar(100 char) NULL DEFAULT NULL COMMENT '创建人名称',
  "create_time" datetime(0) NOT NULL COMMENT '创建时间',
  CLUSTER PRIMARY KEY ("id")
...
CREATE TABLE IF NOT EXISTS "t_wf_evt_log"  (
  "log_nr_" bigint NOT NULL IDENTITY(1, 1) COMMENT '主键',
  "type_" varchar(64 char) NULL DEFAULT NULL COMMENT '类型',
  "proc_def_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '流程定义ID',
  "proc_inst_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '流程实例ID',
  "execution_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '流程执行ID',
  "task_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '任务ID',
  "time_stamp_" timestamp(3) NOT NULL DEFAULT current_timestamp(3) COMMENT '日志时间',
  "user_id_" varchar(255 char) NULL DEFAULT NULL COMMENT '用户ID',
  "data_" blob NULL COMMENT '内容',
...
CREATE TABLE IF NOT EXISTS "t_wf_free_audit"  (
  "id" varchar(50 char) NOT NULL COMMENT '主键ID',
  "process_def_key" varchar(30 char) NULL DEFAULT NULL COMMENT '流程定义key',
  "department_id" varchar(50 char) NOT NULL COMMENT '部门id',
  "department_name" varchar(600 char) NOT NULL COMMENT '部门名称',
  "create_user_id" varchar(50 char) NOT NULL COMMENT '创建人id',
  "create_time" datetime(0) NOT NULL COMMENT '创建时间',
  CLUSTER PRIMARY KEY ("id")
);
...
CREATE TABLE IF NOT EXISTS "t_wf_ge_bytearray"  (
  "id_" varchar(64 char) NOT NULL COMMENT '主键',
  "rev_" int NULL DEFAULT NULL COMMENT '版本号',
  "name_" varchar(255 char) NULL DEFAULT NULL COMMENT '部署的文件名称',
  "deployment_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '部署的ID',
  "bytes_" blob NULL COMMENT '大文本类型，存储文本字节流',
  "generated_" tinyint NULL DEFAULT NULL COMMENT '是否是引擎生成 0为用户生成 1为Activiti生成',
...
CREATE TABLE IF NOT EXISTS "t_wf_ge_property"  (
  "name_" varchar(64 char) NOT NULL COMMENT '名称',
  "value_" varchar(300 char) NULL DEFAULT NULL COMMENT '值',
  "rev_" int NULL DEFAULT NULL COMMENT '版本号',
...
CREATE TABLE IF NOT EXISTS "t_wf_hi_actinst"  (
  ...
  "proc_inst_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '流程实例ID',
  "execution_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '流程执行ID',
  "act_id_" varchar(255 char) NULL DEFAULT NULL COMMENT '活动ID',
  "task_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '任务ID',
  "call_proc_inst_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '调用外部流程的流程实例ID',
  "act_name_" varchar(255 char) NULL DEFAULT NULL COMMENT '活动名称',
  "act_type_" varchar(255 char) NULL DEFAULT NULL COMMENT '活动类型 如startEvent、userTask',
  "assignee_" varchar(255 char) NULL DEFAULT NULL COMMENT '代理人员',
  "start_time_" datetime(0) NULL DEFAULT NULL COMMENT '开始时间',
  "end_time_" datetime(0) NULL DEFAULT NULL COMMENT '结束时间',
  "duration_" bigint NULL DEFAULT NULL COMMENT '时长，耗时',
  "tenant_id_" varchar(255 char) NULL DEFAULT NULL COMMENT '租户ID',
  "proc_def_name" varchar(500 char) NULL DEFAULT NULL COMMENT '流程定义名称',
  "proc_title" varchar(300 char) NULL DEFAULT NULL COMMENT '流程标题',
  "pre_act_id" varchar(255 char) NULL DEFAULT NULL COMMENT '父级活动ID',
  "pre_act_name" varchar(255 char) NULL DEFAULT NULL COMMENT '父级活动名称',
  "pre_act_inst_id" varchar(255 char) NULL DEFAULT NULL COMMENT '父级活动实例ID',
...
CREATE TABLE IF NOT EXISTS "t_wf_hi_attachment"  (
  ...
  "rev_" int NULL DEFAULT NULL COMMENT '版本号',
  "user_id_" varchar(255 char) NULL DEFAULT NULL COMMENT '用户ID',
  "name_" varchar(255 char) NULL DEFAULT NULL COMMENT '附件名称',
  "description_" varchar(4000 char) NULL DEFAULT NULL COMMENT '描述',
  "type_" varchar(255 char) NULL DEFAULT NULL COMMENT '附件类型',
  "task_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '任务Id',
  "proc_inst_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '流程实例ID',
  "url_" varchar(4000 char) NULL DEFAULT NULL COMMENT '附件地址',
  "content_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '内容Id（字节表的ID）',
...
CREATE TABLE IF NOT EXISTS "t_wf_hi_comment"  (
  "id_" varchar(64 char) NOT NULL COMMENT '主键',
  "type_" varchar(255 char) NULL DEFAULT NULL COMMENT '类型：event（事件）comment（意见）',
  "time_" datetime(0) NULL DEFAULT NULL COMMENT '填写时间',
  "user_id_" varchar(255 char) NULL DEFAULT NULL COMMENT '填写人',
  "task_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '任务Id',
  "proc_inst_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '流程实例ID',
  "action_" varchar(255 char) NULL DEFAULT NULL COMMENT '行为类型 （值为下列内容中的一种：AddUserLink、DeleteUserLink、AddGroupLink、DeleteGroupLink、AddComment、AddAttachment、DeleteAttachment）',
  "message_" varchar(4000 char) NULL DEFAULT NULL COMMENT '处理意见',
  "full_msg_" blob NULL COMMENT '全部消息',
  "display_area" varchar(500 char) NULL DEFAULT NULL,
  "top_proc_inst_id_" varchar(100 char) NULL DEFAULT NULL COMMENT '顶级流程实例ID',
  CLUSTER PRIMARY KEY ("id_")
);
...
CREATE TABLE IF NOT EXISTS "t_wf_hi_detail"  (
  "id_" varchar(64 char) NOT NULL COMMENT '主键',
  "type_" varchar(255 char) NULL DEFAULT NULL COMMENT '类型:（表单：FormProperty；参数：VariableUpdate）',
  "proc_inst_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '流程实例ID',
  "execution_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '执行实例ID',
  "task_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '任务实例ID',
  "act_inst_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '活动实例Id',
  "name_" varchar(255 char) NULL DEFAULT NULL COMMENT '名称',
  "var_type_" varchar(255 char) NULL DEFAULT NULL COMMENT '变量类型',
  "rev_" int NULL DEFAULT NULL COMMENT '版本号',
  "time_" datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  "bytearray_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '字节数组Id',
  "double_" double NULL DEFAULT NULL COMMENT '存储变量类型为Double',
  "long_" bigint NULL DEFAULT NULL COMMENT '存储变量类型为long',
  "text_" varchar(4000 char) NULL DEFAULT NULL COMMENT '存储变量值类型为String',
  "text2_" varchar(4000 char) NULL DEFAULT NULL COMMENT '此处存储的是JPA持久化对象时，才会有值。此值为对象ID',
  CLUSTER PRIMARY KEY ("id_")
);
...
CREATE TABLE IF NOT EXISTS "t_wf_hi_identitylink"  (
  "id_" varchar(64 char) NOT NULL COMMENT '主键',
  "group_id_" varchar(255 char) NULL DEFAULT NULL COMMENT '用户组ID',
  "type_" varchar(255 char) NULL DEFAULT NULL COMMENT '用户组类型',
  "user_id_" varchar(255 char) NULL DEFAULT NULL COMMENT '用户ID',
  "task_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '任务Id',
  "proc_inst_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '流程实例ID',
  CLUSTER PRIMARY KEY ("id_")
...
CREATE TABLE IF NOT EXISTS "t_wf_hi_procinst"  (
  "id_" varchar(64 char) NOT NULL COMMENT '主键',
  "proc_inst_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '流程实例ID',
  "business_key_" varchar(32767 char) NULL COMMENT '文档ID，如：gns://xxx/xxx',
  "proc_def_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '流程定义Id',
  "start_time_" datetime(0) NULL DEFAULT NULL COMMENT '开始时间',
  "end_time_" datetime(0) NULL DEFAULT NULL COMMENT '结束时间',
  "duration_" bigint NULL DEFAULT NULL COMMENT '时长',
  "start_user_id_" varchar(255 char) NULL DEFAULT NULL COMMENT '发起人员Id',
  "start_act_id_" varchar(255 char) NULL DEFAULT NULL COMMENT '开始节点',
  "end_act_id_" varchar(255 char) NULL DEFAULT NULL COMMENT '结束节点',
  "super_process_instance_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '超级流程实例Id',
  "delete_reason_" varchar(4000 char) NULL DEFAULT NULL COMMENT '删除理由',
  "tenant_id_" varchar(255 char) NULL DEFAULT NULL COMMENT '租户ID',
  "name_" varchar(255 char) NULL DEFAULT NULL COMMENT '名称',
  "proc_state" int NULL DEFAULT NULL COMMENT '流程状态',
  "proc_def_name" varchar(500 char) NULL DEFAULT NULL COMMENT '流程定义名称',
  "start_user_name" varchar(100 char) NULL DEFAULT NULL COMMENT '发起人名称',
  "starter_org_id" varchar(100 char) NULL DEFAULT NULL COMMENT '发起人组织ID',
  "starter_org_name" varchar(100 char) NULL DEFAULT NULL COMMENT '发起人组织名称',
  "starter" varchar(100 char) NULL DEFAULT NULL COMMENT '发起人',
  "top_process_instance_id_" varchar(100 char) NULL DEFAULT NULL COMMENT '顶级流程实例ID',
  CLUSTER PRIMARY KEY ("id_")
);
...
CREATE TABLE IF NOT EXISTS "t_wf_hi_taskinst"  (
  "id_" varchar(64 char) NOT NULL COMMENT '主键',
  "proc_def_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '流程定义ID',
  "task_def_key_" varchar(255 char) NULL DEFAULT NULL COMMENT '任务定义Key',
  "proc_inst_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '流程实例ID',
  "execution_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '执行实例ID',
  "name_" varchar(255 char) NULL DEFAULT NULL COMMENT '名称',
  "parent_task_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '父节点实例ID',
  "description_" varchar(500 char) NULL DEFAULT NULL,
  "owner_" varchar(255 char) NULL DEFAULT NULL COMMENT '实际签收人 任务的拥有者',
  "assignee_" varchar(255 char) NULL DEFAULT NULL COMMENT '代理人',
  "start_time_" datetime(0) NULL DEFAULT NULL COMMENT '开始时间',
  ...
  "form_key_" varchar(255 char) NULL DEFAULT NULL COMMENT '表单key',
  "category_" varchar(255 char) NULL DEFAULT NULL,
  "tenant_id_" varchar(255 char) NULL DEFAULT NULL COMMENT '租户ID',
  "proc_title" varchar(2000 char) NULL DEFAULT NULL COMMENT '流程标题',
  "sender" varchar(64 char) NULL DEFAULT NULL,
  "pre_task_def_key" varchar(64 char) NULL DEFAULT NULL COMMENT '父级任务定义key',
  "pre_task_id" varchar(64 char) NULL DEFAULT NULL COMMENT '父级任务ID',
  "pre_task_def_name" varchar(255 char) NULL DEFAULT NULL COMMENT '父级任务名称',
  "action_type" varchar(64 char) NULL DEFAULT NULL,
  "top_execution_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '顶级执行ID',
  "sender_org_id" varchar(100 char) NULL DEFAULT NULL COMMENT '发送人组织ID',
  "assignee_org_id" varchar(100 char) NULL DEFAULT NULL COMMENT '代理人组织ID',
  "proc_def_name" varchar(500 char) NULL DEFAULT NULL COMMENT '流程定义名称',
  "status" varchar(100 char) NULL DEFAULT NULL COMMENT '审核状态，1-审核中 2-已拒绝 3-已通过 4-自动审核通过 5-作废 6-发起失败 70-已撤销',
  "biz_id" varchar(100 char) NULL DEFAULT NULL COMMENT '业务主键',
  "doc_id" text NULL COMMENT '文档ID，如：gns://xxx/xxx',
  "doc_name" varchar(1000 char) NULL DEFAULT NULL COMMENT '文档名称',
  "doc_path" varchar(1000 char) NULL DEFAULT NULL COMMENT '文档路径',
  "addition" text NULL COMMENT '业务字段',
  CLUSTER PRIMARY KEY ("id_")
);
...
CREATE TABLE IF NOT EXISTS "t_wf_hi_varinst"  (
  ...
  "task_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '任务Id',
  "name_" varchar(255 char) NULL DEFAULT NULL COMMENT '名称',
  "var_type_" varchar(100 char) NULL DEFAULT NULL COMMENT '变量类型',
  "rev_" int NULL DEFAULT NULL COMMENT '版本号',
  "bytearray_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '字节数组ID',
  "double_" double NULL DEFAULT NULL COMMENT '存储DoubleType类型的数据',
  "long_" bigint NULL DEFAULT NULL COMMENT '存储LongType类型的数据',
  "text_" varchar(4000 char) NULL DEFAULT NULL COMMENT '存储变量值类型为String，如此处存储持久化对象时，值jpa对象的class',
  "text2_" varchar(4000 char) NULL DEFAULT NULL COMMENT '此处存储的是JPA持久化对象时，才会有值。此值为对象ID',
...
CREATE TABLE IF NOT EXISTS "t_wf_org"  (
  "org_id" varchar(50 char) NOT NULL COMMENT '组织编码',
  "org_name" varchar(200 char) NOT NULL COMMENT '组织简称',
  "org_full_name" varchar(500 char) NOT NULL COMMENT '组织全称',
  "org_full_path_name" varchar(4000 char) NULL DEFAULT NULL COMMENT '组织全路径名称',
  "org_full_path_id" varchar(4000 char) NULL DEFAULT NULL COMMENT '组织全路径ID',
  "org_parent_id" varchar(50 char) NOT NULL COMMENT '上级组织编码',
  "org_type" varchar(10 char) NOT NULL COMMENT '组织类型',
  "org_level" int NOT NULL COMMENT '组织级别',
  "org_area_type" varchar(10 char) NOT NULL COMMENT '政府单位区域类别',
  "org_sort" int NULL DEFAULT NULL COMMENT '组织排序号',
  "org_work_phone" varchar(50 char) NULL DEFAULT NULL COMMENT '组织工作手机号',
  "org_work_address" varchar(1000 char) NULL DEFAULT NULL COMMENT '组织工作地址',
  "org_principal" varchar(100 char) NULL DEFAULT NULL COMMENT '组织负责人',
  "org_status" varchar(10 char) NOT NULL COMMENT '组织状态',
  "org_create_time" date NULL DEFAULT NULL COMMENT '组织创建时间',
  "remark" varchar(500 char) NULL DEFAULT NULL COMMENT '备注',
  "fund_code" varchar(20 char) NULL DEFAULT NULL COMMENT '基金编码',
  "fund_name" varchar(100 char) NULL DEFAULT NULL COMMENT '基金名称',
  "company_id" varchar(50 char) NULL DEFAULT NULL COMMENT '公司ID',
  "dept_id" varchar(50 char) NULL DEFAULT NULL COMMENT '部门ID',
  "dept_name" varchar(100 char) NULL DEFAULT NULL COMMENT '部门名称',
  "company_name" varchar(100 char) NULL DEFAULT NULL COMMENT '公司名称',
  "org_branch_leader" varchar(50 char) NULL DEFAULT NULL COMMENT '分管领导ID',
...
CREATE TABLE IF NOT EXISTS "t_wf_process_error_log"  (
  "pelog_id" varchar(36 char) NOT NULL COMMENT '主键，GUID',
  "process_instance_id" varchar(50 char) NULL DEFAULT NULL COMMENT '流程实例ID',
  "process_title" varchar(500 char) NULL DEFAULT NULL COMMENT '流程标题',
  "creator" varchar(50 char) NULL DEFAULT NULL COMMENT '流程发送人',
  "action_type" varchar(50 char) NULL DEFAULT NULL COMMENT '流程操作类型',
  "process_msg" text NULL COMMENT '流程消息内容',
  "pelog_create_time" datetime(0) NULL DEFAULT NULL COMMENT '记录时间',
  "receivers" varchar(4000 char) NULL DEFAULT NULL COMMENT '任务接收者',
  "process_def_name" varchar(500 char) NULL DEFAULT NULL COMMENT '流程定义名称',
  "app_id" varchar(100 char) NULL DEFAULT NULL COMMENT '应用ID',
  "process_log_level" varchar(20 char) NULL DEFAULT NULL COMMENT '日志级别，INFO-信息，ERROR异常',
  "retry_status" varchar(2 char) NULL DEFAULT NULL COMMENT '错误重试状态,y:已处理：n：未处理',
  "error_msg" text NULL COMMENT '异常信息',
  "user_time" varchar(100 char) NULL DEFAULT NULL COMMENT '耗时（毫秒）',
...
CREATE TABLE IF NOT EXISTS "t_wf_process_info_config"  (
  "process_def_id" varchar(100 char) NOT NULL COMMENT '流程定义ID',
  "process_def_name" varchar(500 char) NULL DEFAULT NULL COMMENT '流程定义名称',
  "process_def_key" varchar(100 char) NULL DEFAULT NULL COMMENT '流程KEY',
  "process_type_id" varchar(50 char) NULL DEFAULT NULL COMMENT '流程类型ID',
  "process_type_name" varchar(100 char) NULL DEFAULT NULL COMMENT '流程类型名称',
  "process_page_url" varchar(1000 char) NULL DEFAULT NULL COMMENT '流程表单URL',
  "process_page_info" varchar(4000 char) NULL DEFAULT NULL COMMENT '流程表单数据',
  "process_start_auth" varchar(500 char) NULL DEFAULT NULL COMMENT '流程表单起草权限',
  "process_start_isshow" varchar(10 char) NULL DEFAULT NULL COMMENT '新建流程是否可见，Y-可见，N-不可见',
  "remark" varchar(1000 char) NULL DEFAULT NULL COMMENT '备注',
  "page_isshow_select_usertree" decimal(10, 0) NULL DEFAULT NULL COMMENT '是否展示选人组件',
  "process_handler_class_path" varchar(500 char) NULL DEFAULT NULL COMMENT '流程处理程序类路径',
  "process_start_order" decimal(10, 0) NULL DEFAULT NULL COMMENT '排序号',
  "deployment_id" varchar(64 char) NULL DEFAULT NULL COMMENT '部署ID',
  "create_time" datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  "last_update_time" datetime(0) NULL DEFAULT NULL COMMENT '最后一次修改时间',
  "create_user" varchar(50 char) NULL DEFAULT NULL COMMENT '创建人',
  "create_user_name" varchar(150 char) NULL DEFAULT NULL COMMENT '创建人名称',
  "last_update_user" varchar(50 char) NULL DEFAULT NULL COMMENT '最后一次修改人',
  "tenant_id" varchar(255 char) NULL DEFAULT NULL COMMENT '租户ID',
  "process_mgr_state" varchar(20 char) NULL DEFAULT NULL COMMENT '流程定义管理状态，UNRELEASE-未发布，UPDATE-修订中，RELEASE-已发布',
  "process_model_sync_state" varchar(10 char) NULL DEFAULT NULL COMMENT '流程定义与模型同步状态，Y:已同步,N:未同步',
  "process_mgr_isshow" varchar(10 char) NULL DEFAULT NULL COMMENT '流程定义管理状态：Y:可见，N:不可见',
  "aris_code" varchar(100 char) NULL DEFAULT NULL COMMENT 'arisr流程编码',
  "c_protocl" varchar(50 char) NULL DEFAULT NULL COMMENT 'PC端协议',
  "m_protocl" varchar(50 char) NULL DEFAULT NULL COMMENT '移动端协议',
  "m_url" varchar(500 char) NULL DEFAULT NULL COMMENT '移动端待办地址',
  "other_sys_deal_status" varchar(10 char) NULL DEFAULT NULL COMMENT '移动端处理状态',
  "template" varchar(10 char) NULL DEFAULT NULL COMMENT '是否是流程模板 Y-是',
...
CREATE TABLE IF NOT EXISTS "t_wf_re_deployment"  (
  "id_" varchar(64 char) NOT NULL COMMENT '主键',
  "name_" varchar(255 char) NULL DEFAULT NULL COMMENT '部署包的名称',
  "category_" varchar(255 char) NULL DEFAULT NULL COMMENT '类型',
  "tenant_id_" varchar(255 char) NULL DEFAULT NULL COMMENT '租户',
...
CREATE TABLE IF NOT EXISTS "t_wf_re_model"  (
  "id_" varchar(64 char) NOT NULL COMMENT '主键',
  "rev_" int NULL DEFAULT NULL COMMENT '版本号',
  "name_" varchar(255 char) NULL DEFAULT NULL COMMENT '模型的名称：比如：收文管理',
  "key_" varchar(255 char) NULL DEFAULT NULL COMMENT '模型的关键字，流程引擎用到。比如：FTOA_SWGL',
  "category_" varchar(255 char) NULL DEFAULT NULL COMMENT '类型，用户自己对流程模型的分类。',
  "create_time_" timestamp(0) NULL DEFAULT NULL COMMENT '创建时间',
  "last_update_time_" timestamp(0) NULL DEFAULT NULL COMMENT '最后修改时间',
  "version_" int NULL DEFAULT NULL COMMENT '版本，从1开始。',
  "meta_info_" varchar(4000 char) NULL DEFAULT NULL COMMENT '数据源信息，比如：\n            {\"name\":\"FTOA_SWGL\",\"revision\":1,\"description\":\"丰台财政局OA，收文管理流程\"}',
  "deployment_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '部署ID',
  "editor_source_value_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '编辑源值ID',
  "editor_source_extra_value_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '编辑源额外值ID（外键ACT_GE_BYTEARRAY ）',
  "tenant_id_" varchar(255 char) NULL DEFAULT NULL COMMENT '租户',
  "model_state" varchar(10 char) NULL DEFAULT NULL COMMENT '状态',
  CLUSTER PRIMARY KEY ("id_"),
...
CREATE TABLE IF NOT EXISTS "t_wf_re_procdef"  (
  "id_" varchar(64 char) NOT NULL COMMENT '主键',
  "rev_" int NULL DEFAULT NULL COMMENT '版本号',
  "category_" varchar(255 char) NULL DEFAULT NULL COMMENT '流程命名空间（该编号就是流程文件targetNamespace的属性值）',
  "name_" varchar(255 char) NULL DEFAULT NULL COMMENT '流程名称（该编号就是流程文件process元素的name属性值）',
  "key_" varchar(255 char) NULL DEFAULT NULL COMMENT '流程编号（该编号就是流程文件process元素的id属性值）',
  "version_" int NOT NULL COMMENT '流程版本号（由程序控制，新增即为1，修改后依次加1来完成的）',
  "deployment_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '部署表ID',
  "resource_name_" varchar(4000 char) NULL DEFAULT NULL COMMENT '资源文件名称',
  "dgrm_resource_name_" varchar(4000 char) NULL DEFAULT NULL COMMENT '图片资源文件名称',
  "description_" varchar(4000 char) NULL DEFAULT NULL COMMENT '描述信息',
  "has_start_form_key_" tinyint NULL DEFAULT NULL COMMENT '是否从key启动（start节点是否存在formKey 0否  1是）',
  "has_graphical_notation_" tinyint NULL DEFAULT NULL,
  "suspension_state_" int NULL DEFAULT NULL COMMENT '是否挂起 1激活 2挂起',
  "tenant_id_" varchar(255 char) NULL DEFAULT NULL COMMENT '租户ID',
  "org_id_" varchar(100 char) NULL DEFAULT NULL COMMENT '组织ID',
  CLUSTER PRIMARY KEY ("id_")
);
...
CREATE TABLE IF NOT EXISTS "t_wf_role"  (
  "role_id" varchar(50 char) NOT NULL COMMENT '角色ID',
  "role_name" varchar(500 char) NULL DEFAULT NULL COMMENT '角色名称',
  "role_type" varchar(20 char) NULL DEFAULT NULL COMMENT '角色类型',
  "role_sort" int NULL DEFAULT NULL COMMENT '角色排序号',
  "role_org_id" int NULL DEFAULT NULL COMMENT '角色组织ID',
  "role_app_id" varchar(500 char) NULL DEFAULT NULL COMMENT '角色所属租户',
  "role_status" varchar(10 char) NOT NULL COMMENT '角色状态',
  "role_create_time" datetime(0) NULL DEFAULT NULL COMMENT '角色创建时间',
  "role_creator" varchar(50 char) NULL DEFAULT NULL COMMENT '角色创建者',
  "remark" varchar(500 char) NULL DEFAULT NULL COMMENT '备注',
  "template" varchar(10 char) NULL DEFAULT NULL COMMENT '是否是流程模板 Y-是',
...
CREATE TABLE IF NOT EXISTS "t_wf_ru_event_subscr"  (
  "id_" varchar(64 char) NOT NULL COMMENT '主键',
  "rev_" int NULL DEFAULT NULL COMMENT '版本号',
  "event_type_" varchar(255 char) NULL DEFAULT NULL COMMENT '事件类型',
  "event_name_" varchar(255 char) NULL DEFAULT NULL COMMENT '事件名称',
  "execution_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '流程执行ID',
  "proc_inst_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '流程实例ID',
  "activity_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '活动ID',
  "configuration_" varchar(255 char) NULL DEFAULT NULL COMMENT '配置信息',
...
CREATE TABLE IF NOT EXISTS "t_wf_ru_execution"  (
  ...
  "proc_inst_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '流程实例ID',
  "business_key_" varchar(32767 char) NULL COMMENT '文档ID，如：gns://xxx/xxx',
  "parent_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '父节点实例ID',
  "proc_def_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '流程定义ID',
  "super_exec_" varchar(64 char) NULL DEFAULT NULL,
  "act_id_" varchar(255 char) NULL DEFAULT NULL COMMENT '节点实例ID即ACT_HI_ACTINST中ID',
  "is_active_" tinyint NULL DEFAULT NULL COMMENT '是否存活',
  "is_concurrent_" tinyint NULL DEFAULT NULL COMMENT '是否为并行',
  "is_scope_" tinyint NULL DEFAULT NULL,
  "is_event_scope_" tinyint NULL DEFAULT NULL,
  "suspension_state_" int NULL DEFAULT NULL COMMENT '挂起状态   1激活 2挂起',
  "cached_ent_state_" int NULL DEFAULT NULL COMMENT '缓存结束状态',
  "tenant_id_" varchar(255 char) NULL DEFAULT NULL COMMENT '租户ID',
  "name_" varchar(255 char) NULL DEFAULT NULL COMMENT '名称',
  "lock_time_" timestamp(0) NULL DEFAULT NULL,
  "top_process_instance_id_" varchar(100 char) NULL DEFAULT NULL COMMENT '顶级流程实例ID',
...
CREATE TABLE IF NOT EXISTS "t_wf_ru_identitylink"  (
  ...
  "rev_" int NULL DEFAULT NULL COMMENT '版本号',
  "group_id_" varchar(255 char) NULL DEFAULT NULL COMMENT '用户组ID',
  "type_" varchar(255 char) NULL DEFAULT NULL COMMENT '用户组类型（主要分为以下几种：assignee、candidate、\n\n            owner、starter、participant。即：受让人,候选人,所有者、起动器、参与者）',
  "user_id_" varchar(255 char) NULL DEFAULT NULL COMMENT '用户ID',
  "task_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '任务Id',
  "proc_inst_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '流程实例ID',
  "proc_def_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '流程定义Id',
...
CREATE TABLE IF NOT EXISTS "t_wf_ru_job"  (
  "id_" varchar(64 char) NOT NULL COMMENT '主键',
  "rev_" int NULL DEFAULT NULL COMMENT '版本号',
  "type_" varchar(255 char) NULL DEFAULT NULL COMMENT '类型',
  "lock_exp_time_" timestamp(0) NULL DEFAULT NULL COMMENT '锁定释放时间',
  "lock_owner_" varchar(255 char) NULL DEFAULT NULL COMMENT '挂起者',
  "exclusive_" tinyint NULL DEFAULT NULL,
  "execution_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '执行实例ID',
  "process_instance_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '流程实例ID',
  "proc_def_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '流程定义ID',
  "retries_" int NULL DEFAULT NULL,
  "exception_stack_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '异常信息ID',
  "exception_msg_" varchar(4000 char) NULL DEFAULT NULL COMMENT '异常信息',
  "duedate_" timestamp(0) NULL DEFAULT NULL COMMENT '到期时间',
  "repeat_" varchar(255 char) NULL DEFAULT NULL COMMENT '重复',
  "handler_type_" varchar(255 char) NULL DEFAULT NULL COMMENT '处理类型',
  "handler_cfg_" varchar(4000 char) NULL DEFAULT NULL COMMENT '标识',
  "tenant_id_" varchar(255 char) NULL DEFAULT NULL COMMENT '租户ID',
  CLUSTER PRIMARY KEY ("id_"),
...
CREATE TABLE IF NOT EXISTS "t_wf_ru_task"  (
  ...
  "proc_inst_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '流程实例ID',
  "proc_def_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '流程定义ID',
  "name_" varchar(255 char) NULL DEFAULT NULL COMMENT '任务名称',
  "parent_task_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '父节任务ID',
  "description_" varchar(4000 char) NULL DEFAULT NULL COMMENT '任务描述',
  "task_def_key_" varchar(255 char) NULL DEFAULT NULL COMMENT '任务定义key',
  "owner_" varchar(255 char) NULL DEFAULT NULL COMMENT '拥有者',
  "assignee_" varchar(255 char) NULL DEFAULT NULL COMMENT '代理人',
  "delegation_" varchar(64 char) NULL DEFAULT NULL COMMENT '委托类型，DelegationState分为两种：PENDING，RESOLVED。如无委托则为空',
  "priority_" int NULL DEFAULT NULL COMMENT '优先级别',
  "create_time_" timestamp(0) NULL DEFAULT NULL COMMENT '创建时间',
  "due_date_" datetime(0) NULL DEFAULT NULL COMMENT '执行时间',
  "category_" varchar(255 char) NULL DEFAULT NULL,
  "suspension_state_" int NULL DEFAULT NULL COMMENT '暂停状态 1代表激活 2代表挂起',
  "tenant_id_" varchar(255 char) NULL DEFAULT NULL COMMENT '租户ID',
  "form_key_" varchar(255 char) NULL DEFAULT NULL,
  "proc_title" varchar(2000 char) NULL DEFAULT NULL COMMENT '流程标题',
  "sender" varchar(64 char) NULL DEFAULT NULL,
  "pre_task_def_key" varchar(64 char) NULL DEFAULT NULL COMMENT '父级任务key',
  "pre_task_id" varchar(64 char) NULL DEFAULT NULL COMMENT '父级任务ID',
  "pre_task_def_name" varchar(255 char) NULL DEFAULT NULL COMMENT '父级任务名称',
  "action_type" varchar(64 char) NULL DEFAULT NULL,
  "sender_org_id" varchar(100 char) NULL DEFAULT NULL COMMENT '发送人组织ID',
...
CREATE TABLE IF NOT EXISTS "t_wf_ru_variable"  (
  "id_" varchar(64 char) NOT NULL COMMENT '主键',
  "rev_" int NULL DEFAULT NULL COMMENT '版本号',
  "type_" varchar(255 char) NULL DEFAULT NULL COMMENT '编码类型',
  "name_" varchar(255 char) NULL DEFAULT NULL COMMENT '变量名称',
  "execution_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '执行实例ID',
  "proc_inst_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '流程实例Id',
  "task_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '任务id',
  "bytearray_id_" varchar(64 char) NULL DEFAULT NULL COMMENT '字节组ID',
  "double_" double NULL DEFAULT NULL COMMENT '存储变量类型为Double',
  "long_" bigint NULL DEFAULT NULL COMMENT '存储变量类型为long',
...
CREATE TABLE IF NOT EXISTS "t_wf_sys_log"  (
  "id" varchar(50 char) NOT NULL COMMENT '主键id',
  "type" varchar(10 char) NOT NULL COMMENT '日志类型 info信息，warn警告，error异常',
  "url" varchar(500 char) NULL DEFAULT NULL COMMENT '接口地址',
  "system_name" varchar(20 char) NULL DEFAULT NULL COMMENT '系统名称',
  "user_id" varchar(50 char) NULL DEFAULT NULL COMMENT '访问人ID',
  "msg" varchar(500 char) NOT NULL COMMENT '信息',
...
CREATE TABLE IF NOT EXISTS "t_wf_type"  (
  "type_id" varchar(50 char) NOT NULL COMMENT '类型ID',
  "type_name" varchar(50 char) NOT NULL COMMENT '类型名称',
  "type_parent_id" varchar(50 char) NULL DEFAULT NULL COMMENT '父类型ID',
  "type_sort" decimal(10, 0) NULL DEFAULT NULL COMMENT '排序',
  "app_key" varchar(50 char) NOT NULL COMMENT '应用key',
  "type_remark" varchar(500 char) NULL DEFAULT NULL COMMENT '备注',
...
CREATE TABLE IF NOT EXISTS "t_wf_user"  (
  "user_id" varchar(50 char) NOT NULL COMMENT '用户ID',
  "user_code" varchar(50 char) NOT NULL COMMENT '用户编码',
  "user_name" varchar(50 char) NOT NULL COMMENT '用户姓名',
  "user_sex" varchar(2 char) NULL DEFAULT NULL COMMENT '用户性别',
  "user_age" int NULL DEFAULT NULL COMMENT '用户年龄',
  "company_id" varchar(50 char) NOT NULL COMMENT '直属单位编码',
  "org_id" varchar(50 char) NOT NULL COMMENT '所属单位编码',
  "user_mobile" varchar(50 char) NULL DEFAULT NULL COMMENT '用户手机号码',
  "user_mail" varchar(100 char) NULL DEFAULT NULL COMMENT '用户邮箱',
  "user_work_address" varchar(500 char) NULL DEFAULT NULL COMMENT '用户工作地址',
  "user_work_phone" varchar(100 char) NULL DEFAULT NULL COMMENT '用户工作手机号',
  "user_home_addree" varchar(500 char) NULL DEFAULT NULL COMMENT '用户家庭地址',
  "user_home_phone" varchar(100 char) NULL DEFAULT NULL COMMENT '用户家庭手机号',
  "position_id" varchar(50 char) NULL DEFAULT NULL COMMENT '主要岗位',
  "plurality_position_id" varchar(50 char) NULL DEFAULT NULL COMMENT '兼职岗位',
  "title_id" varchar(1000 char) NULL DEFAULT NULL COMMENT '主要职务',
  "plurality_title_id" varchar(100 char) NULL DEFAULT NULL COMMENT '兼职职务',
  "user_type" varchar(10 char) NULL DEFAULT NULL COMMENT '用户类别',
  "user_status" varchar(10 char) NOT NULL COMMENT '用户状态',
  "user_sort" int NULL DEFAULT NULL COMMENT '用户排序',
  "user_pwd" varchar(20 char) NULL DEFAULT '123456' COMMENT '用户密码',
  ...
  "user_creator" varchar(30 char) NULL DEFAULT NULL COMMENT '用户创建者',
  "remark" varchar(500 char) NULL DEFAULT NULL COMMENT '备注',
  "dept_id" varchar(50 char) NULL DEFAULT NULL COMMENT '直属单位编码',
  "company_name" varchar(100 char) NULL DEFAULT NULL COMMENT '直属单位名称',
  "dept_name" varchar(100 char) NULL DEFAULT NULL COMMENT '直属单位名称',
  "org_name" varchar(100 char) NULL DEFAULT NULL COMMENT '所属单位名称',
...
CREATE TABLE IF NOT EXISTS "t_wf_user2role"  (
  "role_id" varchar(50 char) NOT NULL COMMENT '角色ID',
  "user_id" varchar(500 char) NOT NULL COMMENT '用户ID',
  "remark" varchar(500 char) NULL DEFAULT NULL COMMENT '备注',
  "user_code" varchar(500 char) NULL DEFAULT NULL COMMENT '用户编码',
  "user_name" varchar(500 char) NULL DEFAULT NULL COMMENT '用户名称',
  "org_id" varchar(50 char) NOT NULL COMMENT '组织ID',
  "org_name" varchar(500 char) NULL DEFAULT NULL COMMENT '组织名称',
...
CREATE TABLE IF NOT EXISTS "t_wf_countersign_info"  (
  ...
  "countersign_auditor" varchar(100 char) NULL DEFAULT NULL COMMENT '加签的审核员',
  "countersign_auditor_name" varchar(100 char) NULL DEFAULT NULL COMMENT '加签的审核员名称',
  "countersign_by" varchar(100 char) NULL DEFAULT NULL COMMENT '加签人',
  "countersign_by_name" varchar(100 char) NULL DEFAULT NULL COMMENT '加签人名称',
  "reason" varchar(1000 char) NULL DEFAULT NULL COMMENT '加签原因',
