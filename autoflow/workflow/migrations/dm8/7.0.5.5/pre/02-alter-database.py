...
ALTER_TABLE_DICT = [
    ...
    ["workflow", "t_wf_doc_share_strategy_auditor", "COLUMN", "ADD",    "org_type",    "VARCHAR(32 CHAR) NOT NULL DEFAULT ''",  "组织类型"],
    ["workflow", "t_wf_doc_share_strategy",         "COLUMN", "ADD",    "perm_config", "VARCHAR(64 CHAR) NOT NULL DEFAULT ''",  "申请人权限配置"],
    ["workflow", "t_wf_hi_taskinst",                "COLUMN", "ADD",    "message_id",  "VARCHAR(64 CHAR) NOT NULL DEFAULT ''",  "消息ID"],
]
