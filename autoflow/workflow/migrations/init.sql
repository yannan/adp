...
CREATE TABLE IF NOT EXISTS `t_wf_evt_log`  (
  ...
  `time_stamp_` timestamp(3) NOT NULL DEFAULT current_timestamp(3) ON UPDATE CURRENT_TIMESTAMP(3) COMMENT '日志时间',
...
CREATE TABLE IF NOT EXISTS `t_wf_user`  (
  ...
  `user_update_time` timestamp(0) NOT NULL DEFAULT current_timestamp(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '用户修改时间',
