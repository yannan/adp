...
CREATE TABLE IF NOT EXISTS `t_wf_doc_audit_apply`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `AK_t_wf_doc_audit_application_proc_inst_idx`(`proc_inst_id`) USING BTREE,
  INDEX `AK_t_wf_doc_audit_application_apply_user_idx`(`apply_user_id`) USING BTREE,
  INDEX `AK_t_wf_doc_audit_application_biz_idx`(`biz_id`) USING BTREE,
  INDEX `AK_t_wf_doc_audit_application_biz_typex`(`biz_type`) USING BTREE
...
CREATE TABLE IF NOT EXISTS `t_wf_doc_audit_detail`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `AK_t_wf_doc_audit_detail_apply_idx`(`apply_id`) USING BTREE
...
CREATE TABLE IF NOT EXISTS `t_wf_doc_audit_history`  (
  ...
  `doc_names` varchar(2000) NULL DEFAULT NULL COMMENT '文档名称',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `AK_t_wf_doc_audit_history_proc_inst_idx`(`proc_inst_id`) USING BTREE,
  INDEX `AK_t_wf_doc_audit_history_biz_idx`(`biz_id`) USING BTREE,
  INDEX `AK_t_wf_doc_audit_history_apply_user_id_idx`(`apply_user_id`, `audit_status`, `biz_type`, `last_update_time`) USING BTREE
...
CREATE TABLE IF NOT EXISTS `t_wf_doc_share_strategy`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `AK_T_WF_DOC_SHARE_STRATEGY_PROC_DEF_ID_IDX`(`proc_def_id`) USING BTREE,
  INDEX `AK_T_WF_DOC_SHARE_STRATEGY_ACT_DEF_ID_IDX`(`act_def_id`) USING BTREE
...
CREATE TABLE IF NOT EXISTS `t_wf_doc_share_strategy_auditor`  (
  ...
  `create_time` datetime(0) NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `AK_T_WF_DOC_SHARE_STRATEGY_AUDITOR_STRATEGY_ID_IDX`(`audit_strategy_id`) USING BTREE,
  INDEX `AK_T_WF_DOC_SHARE_STRATEGY_AUDITOR_USER_ID_IDX`(`user_id`) USING BTREE
...
CREATE TABLE IF NOT EXISTS `t_wf_free_audit`  (
  ...
  `create_time` datetime(0) NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `AK_t_wf_free_audit_process_def_keyx`(`process_def_key`) USING BTREE
) ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `t_wf_hi_procinst`  (
  ...
  INDEX `ACT_IDX_HI_PRO_I_BUSKEY`(`business_key_`(50)) USING BTREE
) ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `t_wf_hi_taskinst`  (
  ...
  INDEX `AK_ACT_IDX_HI_TASK_INST_ASSIGNEE`(`assignee_`) USING BTREE,
  INDEX `ACT_IDX_HI_TASK_INST_END_TIME`(`end_time_`) USING BTREE,
  INDEX `ACT_IDX_HI_TASK_DELETE_REASON_`(`assignee_`, `delete_reason_`) USING BTREE
) ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `t_wf_process_error_log`  (
  ...
  INDEX `INDEX_T_WF_ERROR_LOG_APPID`(`app_id`, `process_log_level`, `pelog_create_time`) USING BTREE
) ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `t_wf_ru_execution`  (
  ...
  INDEX `ACT_IDX_EXEC_BUSKEY`(`business_key_`(50)) USING BTREE,
...
CREATE TABLE IF NOT EXISTS `t_wf_ru_task`  (
  ...
  `addition` mediumtext NULL COMMENT '业务字段',
  PRIMARY KEY (`id_`) USING BTREE,
  INDEX `ACT_IDX_TASK_PARENT_TASK_ID`(`parent_task_id_`) USING BTREE,
  INDEX `ACT_FK_TASK_EXE`(`execution_id_`) USING BTREE,
  INDEX `ACT_FK_TASK_PROCINST`(`proc_inst_id_`) USING BTREE,
  INDEX `ACT_FK_TASK_PROCDEF`(`proc_def_id_`) USING BTREE,
  INDEX `AK_ACT_FK_TASK_ASSIGNEE`(`assignee_`) USING BTREE,
  INDEX `ACT_IDX_TASK_ASSIGNEE__LIST_IDX`(`assignee_`, `create_time_`) USING BTREE,
...
-- Records of t_wf_dict
-- ----------------------------
INSERT INTO `t_wf_dict` SELECT uuid(), 'free_audit_secret_level', NULL, '6', NULL, 'Y', NULL, NULL, NULL, NULL, 'as_workflow', '' FROM DUAL WHERE NOT EXISTS(SELECT `dict_code`, `dict_parent_id`, `dict_name`, `sort`, `status`, `creator_id`, `create_date`, `updator_id`, `update_date`, `app_id`, `dict_value` FROM `t_wf_dict` WHERE `dict_code`='free_audit_secret_level');
INSERT INTO `t_wf_dict` SELECT uuid(), 'self_dept_free_audit', NULL, 'Y', NULL, 'Y', NULL, NULL, NULL, NULL, 'as_workflow', '' FROM DUAL WHERE NOT EXISTS(SELECT `dict_code`, `dict_parent_id`, `dict_name`, `sort`, `status`, `creator_id`, `create_date`, `updator_id`, `update_date`, `app_id`, `dict_value` FROM `t_wf_dict` WHERE `dict_code`='self_dept_free_audit');
INSERT INTO `t_wf_dict` SELECT uuid(), 'free_audit_secret_level_enum', NULL, '{\"非密\": 5,\"内部\": 6, \"秘密\": 7,\"机密\": 8}', NULL, 'Y', NULL, NULL, NULL, NULL, 'as_workflow', '' FROM DUAL WHERE NOT EXISTS(SELECT `dict_code`, `dict_parent_id`, `dict_name`, `sort`, `status`, `creator_id`, `create_date`, `updator_id`, `update_date`, `app_id`, `dict_value` FROM `t_wf_dict` WHERE `dict_code`='free_audit_secret_level_enum');
INSERT INTO `t_wf_dict` SELECT uuid(), 'anonymity_auto_audit_switch', NULL, 'n', NULL, 'Y', NULL, NULL, NULL, NULL, 'as_workflow', NULL FROM DUAL WHERE NOT EXISTS(SELECT `dict_code`, `dict_parent_id`, `dict_name`, `sort`, `status`, `creator_id`, `create_date`, `updator_id`, `update_date`, `app_id`, `dict_value` FROM `t_wf_dict` WHERE `dict_code`='anonymity_auto_audit_switch');
INSERT INTO `t_wf_dict` SELECT uuid(), 'rename_auto_audit_switch', NULL, 'n', NULL, 'Y', NULL, NULL, NULL, NULL, 'as_workflow', NULL FROM DUAL WHERE NOT EXISTS(SELECT `dict_code`, `dict_parent_id`, `dict_name`, `sort`, `status`, `creator_id`, `create_date`, `updator_id`, `update_date`, `app_id`, `dict_value` FROM `t_wf_dict` WHERE `dict_code`='rename_auto_audit_switch');