<template>
  <div class="gol-search" :class="isFocus?'is-focus':''" style="max-width: 100%;min-width: 200px;">
    <div class="cell-icon"><i class="el-icon-search" /> </div>
    <div class="cell-text" style="max-width: 57%">
          ...
          :id="index"
           ...
           @keyup.right="rightEvent">
            <div :key="item.value" class="list">
              <span :title="item.value" style="width:100px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;word-break:keep-all;float: left;">{{ item.value }}</span>
    ...
    <div class="cell-input" :style="'max-width: 120px; width: 120px;'">
      <el-autocomplete
        ref="autocomplete"
         v-model="value1"
         class="inline-input"
