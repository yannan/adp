...
ReplaceMenuProvider.prototype._createEntries = function (element, replaceOptions) {
  ...
  forEach(replaceOptions, function (definition) {
    var entry = _this._createMenuEntry(definition, element);
    ...
    switch (entry.actionName) {
      case 'replace-with-default-flow':
        if (businessObject.sourceRef.default !== businessObject &&
          ...
          menuEntries.push(_this._createMenuEntry(entry, element, function () {
      ...
      default:
        ...
        if (is(businessObject.sourceRef, 'bpmn:Activity') && businessObject.conditionExpression) {
          return menuEntries.push(_this._createMenuEntry(entry, element, function () {
...
ReplaceMenuProvider.prototype._getLoopEntries = function (element) {
  ...
  function toggleLoopEntry(event, entry) {
    ...
    if (entry.active) {
      ...
      loopCharacteristics = _this._moddle.create(entry.options.loopCharacteristics);

      if (entry.options.isSequential) {
        loopCharacteristics.isSequential = entry.options.isSequential;
      }
    }
    _this._modeling.updateProperties(element, { loopCharacteristics: loopCharacteristics });
  }
