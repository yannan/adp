 ...
 **/
@Service
public class GatewayOlkCollectionServiceImpl {

    private static final Logger log = LoggerFactory.getLogger(GatewayOlkCollectionServiceImpl.class);
    ...
    protected String getStatementURL(String statement, String user) {
        String urlOpen = serviceEndpoints.getVegaCalculateCoordinator() + QueryConstant.VIRTUAL_V1_STATEMENT_V1;
        StopWatch stopWatch = new StopWatch();
        stopWatch.start();
        HttpResInfo result;
        try{
