...
import com.eisoo.dc.gateway.domain.vo.ViewListVo;
 ...
 **/
@Service
public class GatewayGatewayViewServiceImpl implements GatewayViewService {

    private static final Logger log = LoggerFactory.getLogger(GatewayGatewayViewServiceImpl.class);
    @Autowired
    GatewayOlkCollectionServiceImpl olkCollection;

    @Autowired
    GatewayCatalogServiceImpl catalogService;
