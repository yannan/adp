...
public class CheckUtil {
    ...
    public static String checkCatalog(GatewayCatalogService gatewayCatalogService, String catalog) {
        String catalogStr = gatewayCatalogService.showCatalogInfo(catalog);
    ...
    public static void checkVdmCatalog(GatewayCatalogService gatewayCatalogService, String vdmCatalog) {
        if (org.apache.commons.lang3.StringUtils.isEmpty(vdmCatalog)) {
            ...
            String catalogStr = gatewayCatalogService.showCatalogInfo(vdmCatalog);
