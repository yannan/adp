...
import com.eisoo.dc.common.metadata.mapper.QueryMapper;
import com.eisoo.dc.common.metadata.mapper.TaskMapper;
import com.eisoo.dc.common.util.StringUtils;
import com.eisoo.dc.gateway.common.*;
import com.eisoo.dc.gateway.domain.dto.ResponseMessage;
...
import com.eisoo.dc.gateway.util.JsonUtil;
...
public class TaskServiceImpl implements TaskService {
    ...
    public ResponseEntity<?> scan(String statement, String user, String type) {
        ...
        String urlOpen = serviceEndpoints.getVegaCalculateCoordinator() + QueryConstant.VIRTUAL_V1_SCHEMA_COLUMNS + queryParam.getCatalogName() + "/" + schema + "/" + queryParam.getTable();
    ...
    public String validationCatalog(String catalog, String user) {
        String urlOpen = serviceEndpoints.getVegaCalculateCoordinator() + QueryConstant.VIRTUAL_V1_SCHEMA + catalog;
    ...
    public String getTaskOrigReq(String taskId) {
        String urlOpen = serviceEndpoints.getVegaCalculateCoordinator() + QueryConstant.VIRTUAL_V1_QUERY_TASK + taskId;
        StopWatch stopWatch = new StopWatch();
        stopWatch.start();
        HttpResInfo result;
        try{
    ...
    public CompletableFuture<String> getCreateModelAsync(String statement,String user) {
        String urlOpen = serviceEndpoints.getVegaCalculateCoordinator() + QueryConstant.VIRTUAL_V1_DATA_EXPLORATION;
        StopWatch stopWatch = new StopWatch();
        stopWatch.start();
    ...
    public String getStatement(String statement, String user, String type) {
        String urlOpen = serviceEndpoints.getVegaCalculateCoordinator() + QueryConstant.VIRTUAL_V1_STATEMENT_TASK;
        StopWatch stopWatch = new StopWatch();
        stopWatch.start();
        HttpResInfo result;
        try{
    ...
    public String getTaskReq(String taskId) {
        String urlOpen = serviceEndpoints.getVegaCalculateCoordinator() + QueryConstant.VIRTUAL_V1_QUERY + taskId;
        StopWatch stopWatch = new StopWatch();
        stopWatch.start();
        HttpResInfo result;
        try{
