...
ALTER_TABLE_DICT = [
    ...
    # 数据视图
    ["dip_mdl", "t_data_view", "COLUMN", "ADD", "f_technical_name", "VARCHAR(255 CHAR) NOT NULL DEFAULT ''", "技术名称"],
    ["dip_mdl", "t_data_view", "COLUMN", "ADD", "f_type", " VARCHAR(10 CHAR) NOT NULL DEFAULT ''", "视图类型"],
    ["dip_mdl", "t_data_view", "COLUMN", "ADD", "f_query_type", "VARCHAR(10 CHAR) NOT NULL DEFAULT ''", "查询类型"],
    ["dip_mdl", "t_data_view", "COLUMN", "ADD", "f_data_source_type", " VARCHAR(20 CHAR) NOT NULL DEFAULT ''", "数据源类型"],
    ["dip_mdl", "t_data_view", "COLUMN", "ADD", "f_data_source_id", "VARCHAR(40 CHAR) NOT NULL DEFAULT ''", "数据源 id"],
    ["dip_mdl", "t_data_view", "COLUMN", "ADD", "f_file_name", "VARCHAR(128 CHAR) NOT NULL DEFAULT ''", "文件名"],
    ["dip_mdl", "t_data_view", "COLUMN", "ADD", "f_excel_config", "text DEFAULT NULL", "excel 配置"],
    ["dip_mdl", "t_data_view", "COLUMN", "ADD", "f_data_scope", "text DEFAULT NULL", "数据范围"],
    ["dip_mdl", "t_data_view", "COLUMN", "ADD", "f_status", "VARCHAR(20 CHAR) NOT NULL DEFAULT ''", "状态"],
    ["dip_mdl", "t_data_view", "COLUMN", "ADD", "f_metadata_form_id", "VARCHAR(40 CHAR) NOT NULL DEFAULT ''", "元数据表单 id"],
    ["dip_mdl", "t_data_view", "COLUMN", "ADD", "f_primary_keys", "VARCHAR(255 CHAR) NOT NULL DEFAULT ''", "主键列表"],
    ["dip_mdl", "t_data_view", "COLUMN", "ADD", "f_sql", "text DEFAULT NULL", "生成视图sql"],
    ["dip_mdl", "t_data_view", "COLUMN", "ADD", "f_updater", "VARCHAR(40 CHAR) NOT NULL DEFAULT ''", "更新者id"],
    ["dip_mdl", "t_data_view", "COLUMN", "MODIFY", "f_data_source", "text DEFAULT NULL", "废弃, 数据视图数据来源"],
    ["dip_mdl", "t_data_view", "COLUMN", "MODIFY", "f_field_scope", "TINYINT NOT NULL DEFAULT '0'", "废弃, 字段范围: 0 部分字段, 1 全部字段"],
    ["dip_mdl", "t_data_view", "COLUMN", "MODIFY", "f_filters", "text DEFAULT NULL", "废弃, 过滤条件"],
    ["dip_mdl", "t_data_view", "COLUMN", "MODIFY", "f_open_streaming", "TINYINT NOT NULL DEFAULT 0", "废弃, 是否开启视图实时订阅任务: 0 不开启, 1 开启"],
    ["dip_mdl", "t_data_view", "COLUMN", "MODIFY", "f_job_id", "VARCHAR(40 CHAR) NOT NULL DEFAULT ''", "废弃, 订阅任务 id"],
    ["dip_mdl", "t_data_view", "COLUMN", "MODIFY", "f_loggroup_filters", "text DEFAULT NULL", "废弃, 日志分组过滤条件"],

    # 指标模型
    ["dip_mdl", "t_metric_model", "COLUMN", "ADD", "f_catalog_id", "VARCHAR(40 CHAR) NOT NULL DEFAULT ''", "编目模板id"],
    ["dip_mdl", "t_metric_model", "COLUMN", "ADD", "f_catalog_content", "text DEFAULT NULL", "编目内容"],
    ["dip_mdl", "t_metric_model", "COLUMN", "MODIFY", "f_analysis_dimessions", "VARCHAR(8192 CHAR) DEFAULT NULL", "分析维度"],

    # 数据字典
    ["dip_mdl", "t_data_dict_item", "COLUMN", "MODIFY", "f_item_key", "VARCHAR(3000 CHAR) NOT NULL", "数据字典项key值"],
    ["dip_mdl", "t_data_dict_item", "COLUMN", "MODIFY", "f_item_value", "VARCHAR(3000 CHAR) NOT NULL", "数据字典项value值"],
]
