...
ALTER_TABLE_DICT = [
    ...
    ["dip_mdl", "t_metric_model",  "COLUMN", "ADD", "f_data_source", "VARCHAR(255 CHAR) NOT NULL",  "数据源"],
    ["dip_mdl", "t_metric_model",  "COLUMN", "ADD", "f_formula_config", "text DEFAULT NULL", "配置化计算公式"],
    ["dip_mdl", "t_metric_model",  "COLUMN", "ADD", "f_analysis_dimessions", "VARCHAR(1024 CHAR) DEFAULT NULL", "分析维度"],
    ["dip_mdl", "t_metric_model_task",  "COLUMN", "ADD", "f_creator", "VARCHAR(40 CHAR) NOT NULL DEFAULT ''", "创建任务的用户id"],
    ["dip_mdl", "t_metric_model",  "COLUMN", "ADD", "f_creator", "VARCHAR(40 CHAR) NOT NULL DEFAULT ''", "创建者id"],
    ["dip_mdl", "t_data_view",  "COLUMN", "ADD", "f_creator", "VARCHAR(40 CHAR) NOT NULL DEFAULT ''", "创建者id"],
    ["dip_mdl", "t_data_model_job",  "COLUMN", "ADD", "f_creator", "VARCHAR(40 CHAR) NOT NULL DEFAULT ''", "创建者id"],
    ["dip_mdl", "t_objective_model",  "COLUMN", "ADD", "f_creator", "VARCHAR(40 CHAR) NOT NULL DEFAULT ''", "创建者id"],
    ["dip_mdl", "t_event_models",  "COLUMN", "ADD", "f_creator", "VARCHAR(40 CHAR) NOT NULL DEFAULT ''", "创建者id"],
    ["dip_mdl", "t_event_model_task",  "COLUMN", "ADD", "f_creator", "VARCHAR(40 CHAR) NOT NULL DEFAULT ''", "创建者id"],
    ["dip_mdl", "t_trace_model",  "COLUMN", "ADD", "f_creator", "VARCHAR(40 CHAR) NOT NULL DEFAULT ''", "创建者id"],
    ["dip_mdl", "t_data_dict",  "COLUMN", "ADD", "f_creator", "VARCHAR(40 CHAR) NOT NULL DEFAULT ''", "创建者id"],
]
