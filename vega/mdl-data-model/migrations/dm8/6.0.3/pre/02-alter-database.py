...
ALTER_TABLE_DICT = [
    ...
    # 数据视图
    ["dip_mdl", "t_data_view", "COLUMN", "ADD", "f_meta_table_name", "VARCHAR(1024 CHAR) NOT NULL DEFAULT ''", "元数据表名"],

    # 数据视图分组
    ["dip_mdl", "t_data_view_group", "UNIQUE INDEX", "DROP", "uk_f_group_name", "", ""],
    ["dip_mdl", "t_data_view_group", "UNIQUE INDEX", "ADD", "uk_f_group_name", "f_builtin,f_group_name", ""],
]
