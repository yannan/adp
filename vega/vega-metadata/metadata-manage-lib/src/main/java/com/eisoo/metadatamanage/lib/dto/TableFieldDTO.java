...
@ApiModel
public class TableFieldDTO implements IExcelModel{
...
//	@Excel(name = "*字段类型", orderNum = "2", width = 20 , dict = "fieldType", addressList = true)
	...
	@ApiModelProperty(value = "字段类型", example = "varchar", dataType = "java.lang.String")
    ...
    @JsonIgnore
	@Excel(name = "字段校验错误描述", orderNum = "6", width = 40)
